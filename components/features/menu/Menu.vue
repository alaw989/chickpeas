  ...
  <div class="w-full mx-auto flex justify-center ">
    <div class="w-full mx-auto menu-wrapper section-wrap px-4 md:px-0">
      ...
      <div
        ...
        role="tabpanel"
        :id="`panel-${currentCategoryDataKey}`"
        :aria-labelledby="`tab-${currentCategoryDataKey}`"
      >
...
export default {
  ...
  methods: {
    ...
    handleTabKeydown(event, currentCategory) {
      ...
      this.$nextTick(() => {
        const tabId = `tab-${categories[newIndex].dataKey}`
...
.skeleton-line.title { width: 60%; height: 1.25rem; }
.skeleton-line.description { width: 80%; }
