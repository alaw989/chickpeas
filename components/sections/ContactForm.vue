    ...
    <div class="contact-form section-wrap">
      ...
      <form @submit.prevent="submit" novalidate>
        ...
        <div class="form-field">
          ...
          <div class="name-row">
            <div class="input-wrapper">
              ...
              />
              <p id="firstName-error" role="alert" class="error-message" v-if="errors.firstName">
                {{ errors.firstName }}
              </p>
            </div>
            <div class="input-wrapper">
              ...
              />
              <p id="lastName-error" role="alert" class="error-message" v-if="errors.lastName">
                {{ errors.lastName }}
              </p>
            </div>
          </div>
        ...
        <div class="form-field">
          ...
          />
          <p id="email-error" role="alert" class="error-message" v-if="errors.email">
            {{ errors.email }}
          </p>
        </div>
        ...
        <div class="form-field">
          ...
          />
          <p id="subject-error" role="alert" class="error-message" v-if="errors.subject">
            {{ errors.subject }}
          </p>
        </div>
        ...
        <div class="form-field">
          ...
          <textarea
              ...
              rows="6"
          ></textarea>
          <p id="message-error" role="alert" class="error-message" v-if="errors.message">
            {{ errors.message }}
          </p>
        </div>
        ...
        <!-- Status messages -->
        <p v-if="ok" role="status" aria-live="polite" class="mt-3 success-message">Thanks! We'll be in touch.</p>
        <p v-if="err" role="alert" aria-live="assertive" class="mt-3 error-message">{{ err }}</p>
      </form>
    </div>
  </div>
</template>
...
export default defineComponent({
  ...
  methods: {
    ...
    validateForm(): boolean {
      ...
      if (!isValid) {
        this.notifyError('Please fix the errors in the form.')
      }
      return isValid
    },
